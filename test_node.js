...
var server = http.createServer(function(req, res) {
    ...
    res.write('<!DOCTYPE html>'+
        ...
        '<p>Server: </p>' +
        ' <script type="text/javascript"> trends.embed.renderWidget("US_cu_5xacMlYBAAAtpM_en", "fe_geo_vgbchart_3b9ce31b-cd31-4e2d-96b6-35cb21e01a06", {"guestPath":"https://trends.sandbox.google.com:443/trends/embed/"}); </script> '+
        ' </body>'+
        '</html>');
});
